...
public class OtrSm implements OtrTlvHandler {
	...
	public OtrSm(AuthContext authContext, OtrKeyManager keyManager, SessionID sessionId,
	 ...
	 */
	public List<TLV> initRespondSmp(String question, String secret, boolean initiating) throws SMException, OtrException {
		...
		final KeyPair localKeyPair = authContext.getLocalDHKeyPair();
        final PublicKey theirKey = authContext.getRemoteDHPublicKey();

		byte[] sessionId = computeSessionId(localKeyPair.getPrivate(), theirKey);
